...
module.exports =  {
     ...
     * @return {[type]}         [description]
     */
    copy: function(srcDir, destDir, options) {
        try {
            fset.copySync(srcDir, destDir, options);
        }catch(err) {
            console.error(err);
        }
    },
     ...
     * @return {[type]}         [description]
     */
    move: function(srcDir, destDir, options) {
        fset.move(srcDir, destDir, options, function(err) {
