...
module.exports =  {
    ...
    server_pid: function(value) {
        ...
        if(arguments.length) {
            return value ? me.write(path, value) : me.remove(path);
        }else {
    ...
    server_start: function() {
        ...
        open(address, server.browser, (error, stdout, stderr) => {
            if (error) {
    ...
    open: function(path, callback) {
        ...
        child_process.exec(cmd, (error, stdout, stderr) => {
            ...
            console.log(`[Info] open success, stdout: ${stdout}, stderr: ${stderr}`);
        });
    },
